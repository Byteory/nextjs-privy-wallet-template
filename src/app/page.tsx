  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-6">Next.js 15.3 Template Using Privy and TailwindCSS</h1>
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
          ...
          <div>
            ...
            <div className="inline-block bg-gray-800 px-3 py-1 rounded text-sm font-mono">/src/lib/wagmiConfig.ts</div>
          </div>
        </div>
        <a
          href="https://github.com/Byteory/nextjs-privy-wallet-template"
          target="_blank"
